...
public:
	void virtual create_account(char type);
	...
	char rettype() const;
	double interestRate;//bankaccount
};

void account::create_account(char type)
{
...
public:
	...
	void create_account(char type) override
	{
		account::create_account(type);
...
void write_account()
{
	...
	cout << "\nEnter Type of The account (C/I) : " << endl;
	cin >> type;
	type = toupper(type);
	if (type == 'C')
	{
...
void intro()
{
	...
	cout << "\n\n\tMANAGEMENT";
	cout << "\n\n\t  SYSTEM";
	cout << "\n\n\n\nMADE BY : YOUSUF RAZA,ZARRAR KZ,SHAYAN  ";
